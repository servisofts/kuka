...
class ClienteRegistroPage extends Component {
  static roles = {
    "d16d800e-5b8d-48ae-8fcb-99392abdf61f": "cliente",
    "b5b4a616-dd16-4443-b859-39245f50c8df": "relacionador",
  ...
  constructor(props) {
    ...
    this.key_rol = this.props.navigation.getParam("key_rol", false);
  ...
  onPress() {
    ...
    var object = {
      ...
      key_rol: this.key_rol ? this.key_rol : "d16d800e-5b8d-48ae-8fcb-99392abdf61f",
      data: {
        ...this.data,
        ...objectResult,
      },
