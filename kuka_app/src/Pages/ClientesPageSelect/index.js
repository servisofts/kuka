...
class ClientesPageSelect extends Component {
  ...
  render() {
    ...
    return (<>
      <View style={{
        ...
        <BackgroundImage />
        <BarraSuperior title={"Seleccionar cliente"} navigation={this.props.navigation} goBack={() => {
          this.props.navigation.goBack();
        }} />
        <Buscador ref={(ref) => {
...
export default connect(initStates)(ClientesPageSelect);