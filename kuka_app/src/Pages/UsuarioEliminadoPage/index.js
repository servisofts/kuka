...
class UsuarioEliminadoPage extends Component {
  ...
  render() {
    ...
    return (<>
      <View style={{
        ...
        <BackgroundImage />
        <BarraSuperior title={"Usuarios eliminados"} navigation={this.props.navigation} goBack={() => {
...
export default connect(initStates)(UsuarioEliminadoPage);